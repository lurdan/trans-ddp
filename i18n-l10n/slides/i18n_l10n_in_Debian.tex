...
\begin{frame}
  \frametitle{Web site translation}
	\begin{block}
		{Translated content}
		\begin{itemize}
		\item Distributed through Content Negotiation
		\item Managed with:
		\begin{itemize}
	...
	\begin{block}
		...
		\item 6 languages over 50\% pages translated (7 if counting size \%)
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
  \frametitle{Packages descriptions (DDTP)}
	...
	\begin{block}
		{Issues}
		\begin{itemize}
		\item Project was abandoned (DONE)
		\item Needed APT changes (DONE)
