...
% Images used for World domination:
...
% Images used for l10n process
\pgfdeclareimage[width=8cm]{diagram-upstream-l10n}{diagram-upstream-l10n}
\pgfdeclareimage[width=8cm]{diagram-debian-l10n}{diagram-debian-l10n}
...
\begin{frame}
  ...
  \pgfuseimage{spongebob}<1>
  \pgfuseimage{potato}<2>
  \pgfuseimage{woody}<3>
  \pgfuseimage{sarge}<4>
  \pgfuseimage{etch_beta}<5>
  \pgfuseimage{etch}<6>
  \pgfuseimage{potato}<7>
  \pgfuseimage{woody}<8>
  \pgfuseimage{sarge}<9>
  \pgfuseimage{etch_beta}<10>
  \pgfuseimage{etch}<11>
...
%\begin{frame}
%  \frametitle{Native Debian packages}
%	\begin{block}
...
%\pgfuseimage{diagram-upstream-l10n}
%\end{frame}

%\begin{frame}
%  \frametitle{Translations done within Debian}
%\pgfuseimage{diagram-debian-l10n}
%\end{frame}
...
\begin{frame}
  \frametitle{Conclusion}
	\begin{block}
		{We need i18n in more areas}
	\end{block}
	\begin{block}
		{We need to target more languages}
	\end{block}
	\begin{block}
